...
async def select_user_by_id(db_url: str, user_id: str) -> str:
    async with await psycopg.AsyncConnection.connect(db_url) as conn:
        async with conn.cursor() as cur:
            await cur.execute(
                """SELECT username FROM user_table WHERE id = %s""",
                user_id)
...
async def select_user_by_username(db_url: str, username: str) -> str:
    async with await psycopg.AsyncConnection.connect(db_url) as conn:
        async with conn.cursor() as cur:
            await cur.execute(
    ...
    async with await psycopg.AsyncConnection.connect(db_url) as conn:
        ...
        async with conn.cursor() as cur:
            ...
            await cur.execute(
                ...
                is_admin,
                created_at,
                updated_at) VALUES (%s, %s, %s, %s, %s, %s, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)""",
